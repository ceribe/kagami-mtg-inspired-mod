...
{
	public class Sword_of_Light_and_Shadow : ModItem
	{
        private short counter = 0;
        public override void SetStaticDefaults()
		{
            DisplayName.SetDefault("Sword of Light and Shadow");
            Tooltip.SetDefault("Legendary Sword\nLMB & RMB unlocked post-Moon Lord");  //The (English) text shown below your weapon's name
		}
		...
		public override void MeleeEffects(Player player, Rectangle hitbox)
		{
			...
			{
				Dust.NewDust(new Vector2(hitbox.X, hitbox.Y), hitbox.Width, hitbox.Height, 198);
			}
		}

		public override void OnHitNPC(Player player, NPC target, int damage, float knockback, bool crit)
		{
			//target.AddBuff(BuffID.OnFire, 60); TODO JAKIŒ DEBUFF
		}
