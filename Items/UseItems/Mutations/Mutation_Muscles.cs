...
{
	class Mutation_Muscles : ModItem
	{
		public override void SetStaticDefaults()
		{
            DisplayName.SetDefault("Mutation: Muscles");
            Tooltip.SetDefault("Permamently increse swing speed by 5% and grants immunity to knockback\nRemoves all other mutations on use");
        }
		...
		{
            player.GetModPlayer<KagamiPlayer>().Mutation = 4;
			return true;
		}
